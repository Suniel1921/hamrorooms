  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        console.log('Exception error toast'); // Debug log
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="formGroup">
          ...
          <input
            ...
            onChange={formik.handleChange}
            value={formik.values.email}
            className={formik.errors.email && formik.touched.email ? "errorInput" : ""}
          />
        ...
        <div className="formGroup">
          ...
          <div className="passwordInputWrapper">
            <input
              ...
              onChange={formik.handleChange}
              value={formik.values.password}
              className={formik.errors.password && formik.touched.password ? "errorInput" : ""}
            />
            <span className="passwordToggleIcon" onClick={handleShowHidePassword}>
